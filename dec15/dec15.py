...
class dec15(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "dec15")
        ...
        self.low_pass_filter_0 = filter.fir_filter_fff(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.filter_fft_low_pass_filter_0 = filter.fft_filter_fff(1, firdes.low_pass(4, samp_rate, 500, 100, window.WIN_HAMMING, 6.76), 1)
        ...
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/manu/Documents/private/hackvent22/dec15/message_1msps.wav', True)
        self.blocks_uchar_to_float_0 = blocks.uchar_to_float()
        self.blocks_throttle_0 = blocks.throttle(gr.sizeof_float*1, samp_rate,True)
        self.blocks_pack_k_bits_bb_0 = blocks.pack_k_bits_bb(8)
        self.blocks_float_to_complex_0 = blocks.float_to_complex(1)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/manu/Documents/private/hackvent22/dec15/out.bin', False)
        ...
        self.connect((self.filter_fft_low_pass_filter_0, 0), (self.blocks_float_to_complex_0, 1))
...
def main(top_block_cls=dec15, options=None):
