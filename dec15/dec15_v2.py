...
class dec15_v2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "dec15_v2")
        ...
        # Blocks
        ##################################################
        self._decimation_range = Range(0, 256, 1, 64, 200)
        ...
        self.qtgui_time_sink_x_2 = qtgui.time_sink_f(
            1024, #size
            samp_rate/decimation/23/2, #samp_rate
            "", #name
            1, #number of inputs
            None # parent
        )
        ...
        self.low_pass_filter_0 = filter.fir_filter_fff(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.filter_fft_low_pass_filter_0 = filter.fft_filter_ccc(1, firdes.low_pass(4, samp_rate, 500, 100, window.WIN_HAMMING, 6.76), 1)
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/manu/Documents/private/hackvent22/dec15/message_1msps.cu8', True, 0, 0)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/manu/Documents/private/hackvent22/dec15/out2.bin', False)
        ...
        self.connect((self.blocks_deinterleave_0, 0), (self.blocks_uchar_to_float_1, 0))
        self.connect((self.blocks_deinterleave_0, 1), (self.blocks_uchar_to_float_1_0, 0))
        self.connect((self.blocks_file_source_0, 0), (self.blocks_throttle_0, 0))
        self.connect((self.blocks_float_to_complex_0, 0), (self.filter_fft_low_pass_filter_0, 0))
        ...
        self.connect((self.blocks_uchar_to_float_1_0, 0), (self.blocks_float_to_complex_0, 1))
        ...
        self.connect((self.filter_fft_low_pass_filter_0, 0), (self.analog_am_demod_cf_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.filter_fft_low_pass_filter_0.set_taps(firdes.low_pass(4, self.samp_rate, 500, 100, window.WIN_HAMMING, 6.76))
        self.low_pass_filter_0.set_taps(firdes.low_pass(10, self.samp_rate/self.decimation, 150, 100, window.WIN_HAMMING, 6.76))
        ...
        self.qtgui_time_sink_x_2.set_samp_rate(self.samp_rate/self.decimation/23/2)
...
def main(top_block_cls=dec15_v2, options=None):
